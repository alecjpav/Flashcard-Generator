...
inquirer.prompt([{
    ...
    if (answer.playGame === "No-Thanks") {
        ...
        showCards();
        console.log("\n");
        console.log("The following questions will have one word answers. Please spell them correctly and use proper capitalization.");
        console.log("==============================================================================================================");
...
var showCards = function() {
    // read the trivia.txt file
    fs.readFile('./trivia.txt', 'utf8', function(error, data) {
